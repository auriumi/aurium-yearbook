...
function ImageSlot({ label, icon: Icon, image, onUpload, setEnlargedImage }: ImageSlotProps) {
  ...
  return (
    <div className="min-w-0 rounded-xl border border-stone-200 bg-white p-3 shadow-sm">
      ...
      <div className="space-y-4 pb-10 min-h-[400px]">
        {isLoading ? (
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-4 shadow-sm sm:p-5">
            ...
            <div className="grid grid-cols-1 gap-5 content-start xl:grid-cols-2">
              {students.map((student: any) => {
                ...
                return (
                  <div key={student.id} className="overflow-hidden rounded-2xl border border-stone-200 bg-[#FDFBF7] shadow-sm">
                    ...
                    <div className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-[150px_minmax(0,1fr)_minmax(0,1fr)]">
