...
import { DEFAULT_GRADUATING_YEAR, DEFAULT_GRADUATION_TERM, departmentOptions } from "@/constants/registration";
...
export default function RegistrationWizard() {
  ...
  const [graduatingYear, setGraduatingYear] = useState(String(DEFAULT_GRADUATING_YEAR));
  const [graduationTerm, setGraduationTerm] = useState(DEFAULT_GRADUATION_TERM);
  ...
  const isStepValid = () => {
    ...
    switch (currentStep) {
      ...
      case 3: 
        ...
        const isBaseAcademicValid = selectedDepartment !== "" && selectedCourse !== "" && selectedMajor !== "" && graduatingYear !== "" && graduationTerm !== "" && thesisTitle.trim() !== "" && contactNum.trim() !== "" && isValidEmailFormat(email);
  ...
  const onSubmit = async () => {
    ...
    const body = { 
        ...
        academics: {
          ...
          major: selectedMajor,
          graduating_year: Number(graduatingYear),
