...
export const ReviewStep = ({ idNumber, fname, mname, lname, suffix, nickname, formattedBirthdate, barangayName, cityName, provinceName, selectedDepartment, selectedCourse, selectedMajor, graduatingYear, graduationTerm, thesisTitle, umEmail, contactNum, email, useGuardian, guardianTitle, guardianFname, guardianLname, guardianRel, fatherTitle, fatherFname, fatherMname, fatherLname, fatherSuffix, motherTitle, motherFname, motherMname, motherLname, reviewConfirmed, setReviewConfirmed }: any) => (
    ...
    <div className="bg-stone-50/80 border border-stone-200 rounded-xl p-6 shadow-sm">
        ...
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-stone-100">
                <div><span className="block text-[10px] uppercase tracking-wider text-stone-500 font-bold mb-1">Graduating Year</span><span className="text-stone-900 font-bold">{graduatingYear || "-"}</span></div>
                <div><span className="block text-[10px] uppercase tracking-wider text-stone-500 font-bold mb-1">Graduation Term</span><span className="text-stone-900 font-bold">{getGraduationTermLabel(graduationTerm)}</span></div>
            </div>
